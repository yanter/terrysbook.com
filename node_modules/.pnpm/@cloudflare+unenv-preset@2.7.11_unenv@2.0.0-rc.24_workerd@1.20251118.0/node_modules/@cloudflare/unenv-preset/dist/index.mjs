...
function getDomainOverrides({
  ...
  const enabledByFlag = compatibilityFlags.includes("enable_nodejs_domain_module") && compatibilityFlags.includes("experimental");
  const enabled = enabledByFlag && !disabledByFlag;
  return enabled ? {
...
function getWasiOverrides({
  ...
  const enabledByFlag = compatibilityFlags.includes("enable_nodejs_wasi_module") && compatibilityFlags.includes("experimental");
  const enabled = enabledByFlag && !disabledByFlag;
  return enabled ? {
    nativeModules: ["wasi"],
    hybridModules: []
